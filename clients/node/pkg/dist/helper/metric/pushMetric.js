...
let _apiKey = "";
let interval = null;
function pushMetricsToApi() {
    return __awaiter(this, void 0, void 0, function* () {
        if (_apiKey && (pendingMetrics === null || pendingMetrics === void 0 ? void 0 : pendingMetrics[0])) {
            let sending = pendingMetrics.splice(0);
            let config = {
                method: "post",
                timeout: 30000,
...
function pushMetric({ apiKey, data, }) {
    _apiKey = apiKey;
